...
export default function Home() {
  return (
    <main className="grid grid-cols-[auto,auto,1fr]    h-screen w-screen gap-6 bg-purple-300 ">
      ...
      <div className="bg-yellow-400 self-center justify-self-center   ">3</div>
...
// grid-cols-[auto,auto,1fr] In this case justify center won't work as space will be cooupied bcz of 1fr
